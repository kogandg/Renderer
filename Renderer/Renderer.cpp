...
int main()
{
	...
	shared_ptr<Material> centerSphereMaterial = make_shared<Dielectric>(1.5);
	shared_ptr<Material> leftSphereMaterial = make_shared<Metal>(Color(0.8, 0.8, 0.8), 0.3);
	shared_ptr<Material> rightSphereMaterial = make_shared<Metal>(Color(0.8, 0.6, 0.2), 1.0);
